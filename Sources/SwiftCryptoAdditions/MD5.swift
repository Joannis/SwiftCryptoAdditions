...
public struct MD5Digest: DigestImplementation {
    fileprivate let bytes: [UInt8]
    public static let byteCount = MD5.byteCount
...
public struct MD5 : HashFunctionImplementation {
    public typealias Digest = MD5Digest
    
    internal static let littleEndian = true
